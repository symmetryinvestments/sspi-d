...
BOOL LoadUserProfileA( _In_    HANDLE          hToken, _Inout_ LPPROFILEINFOA  lpProfileInfo);
BOOL LoadUserProfileW( _In_    HANDLE          hToken, _Inout_ LPPROFILEINFOW  lpProfileInfo);
...
BOOL GetProfilesDirectoryA( _Out_writes_opt_(*lpcchSize)    LPSTR lpProfileDir, _Inout_                         LPDWORD lpcchSize); 
BOOL GetProfilesDirectoryW( _Out_writes_opt_(*lpcchSize)    LPWSTR lpProfileDir, _Inout_                         LPDWORD lpcchSize);
...
BOOL GetProfileType( _Out_ DWORD *dwFlags);
...
HRESULT CreateProfile( _In_                            LPCWSTR pszUserSid, _In_                            LPCWSTR pszUserName, _Out_writes_(cchProfilePath)    LPWSTR  pszProfilePath, _In_                            DWORD   cchProfilePath); 
...
BOOL GetDefaultUserProfileDirectoryA( _Out_writes_opt_(*lpcchSize)    LPSTR lpProfileDir, _Inout_                         LPDWORD lpcchSize);
BOOL GetDefaultUserProfileDirectoryW( _Out_writes_opt_(*lpcchSize)    LPWSTR lpProfileDir, _Inout_                         LPDWORD lpcchSize);
...
BOOL GetAllUsersProfileDirectoryA( _Out_writes_opt_(*lpcchSize)    LPSTR lpProfileDir, _Inout_                         LPDWORD lpcchSize);
BOOL GetAllUsersProfileDirectoryW( _Out_writes_opt_(*lpcchSize)    LPWSTR lpProfileDir, _Inout_                         LPDWORD lpcchSize);
...
BOOL GetUserProfileDirectoryA( _In_                            HANDLE  hToken, _Out_writes_opt_(*lpcchSize)    LPSTR lpProfileDir, _Inout_                         LPDWORD lpcchSize);
BOOL GetUserProfileDirectoryW( _In_                            HANDLE  hToken, _Out_writes_opt_(*lpcchSize)    LPWSTR lpProfileDir, _Inout_                         LPDWORD lpcchSize);
...
BOOL ExpandEnvironmentStringsForUserA( _In_opt_                HANDLE      hToken, _In_                    LPCSTR    lpSrc, _Out_writes_(dwSize)    LPSTR     lpDest, _In_                    DWORD       dwSize);
BOOL ExpandEnvironmentStringsForUserW( _In_opt_                HANDLE      hToken, _In_                    LPCWSTR    lpSrc, _Out_writes_(dwSize)    LPWSTR     lpDest, _In_                    DWORD       dwSize);
...
alias PGROUP_POLICY_OBJECTA = GROUP_POLICY_OBJECTA*;
...
alias PGROUP_POLICY_OBJECTW = GROUP_POLICY_OBJECTW*;
...
BOOL GetGPOListA ( _In_opt_    HANDLE      hToken, _In_opt_    LPCSTR    lpName, _In_opt_    LPCSTR    lpHostName, _In_opt_    LPCSTR    lpComputerName, _In_        DWORD       dwFlags, _Outptr_ PGROUP_POLICY_OBJECTA * pGPOList);

BOOL GetGPOListW ( _In_opt_    HANDLE      hToken, _In_opt_    LPCWSTR    lpName, _In_opt_    LPCWSTR    lpHostName, _In_opt_    LPCWSTR    lpComputerName, _In_        DWORD       dwFlags, _Outptr_ PGROUP_POLICY_OBJECTW * pGPOList);
...
BOOL FreeGPOListA ( _In_        PGROUP_POLICY_OBJECTA   pGPOList); 
BOOL FreeGPOListW ( _In_        PGROUP_POLICY_OBJECTW   pGPOList);
...
DWORD GetAppliedGPOListA ( _In_        DWORD       dwFlags, _In_opt_    LPCSTR    pMachineName, _In_opt_    PSID        pSidUser, _In_        GUID        *pGuidExtension, _Outptr_ PGROUP_POLICY_OBJECTA   *ppGPOList);

DWORD GetAppliedGPOListW ( _In_        DWORD       dwFlags, _In_opt_    LPCWSTR    pMachineName, _In_opt_    PSID        pSidUser, _In_        GUID        *pGuidExtension, _Outptr_ PGROUP_POLICY_OBJECTW   *ppGPOList);
...
DWORD GenerateGPNotification ( _In_ BOOL bMachine, _In_ LPCWSTR lpwszMgmtProduct, _In_ DWORD dwMgmtProductOptions);
...
HRESULT CreateAppContainerProfile( _In_ PCWSTR pszAppContainerName, _In_ PCWSTR pszDisplayName, _In_ PCWSTR pszDescription, _In_reads_opt_(dwCapabilityCount) PSID_AND_ATTRIBUTES pCapabilities, _In_ DWORD dwCapabilityCount, _Outptr_ PSID* ppSidAppContainerSid);
...
HRESULT DeleteAppContainerProfile( _In_ PCWSTR pszAppContainerName);
...
HRESULT GetAppContainerRegistryLocation( _In_ REGSAM desiredAccess, _Outptr_ PHKEY phAppContainerKey); 
...
HRESULT GetAppContainerFolderPath( _In_ PCWSTR pszAppContainerSid, _Outptr_ PWSTR *ppszPath); 
...
HRESULT DeriveAppContainerSidFromAppContainerName( _In_ PCWSTR pszAppContainerName, _Outptr_ PSID *ppsidAppContainerSid);
...
HRESULT DeriveRestrictedAppContainerSidFromAppContainerSidAndRestrictedName( _In_ PSID psidAppContainerSid, _In_ PCWSTR pszRestrictedAppContainerName, _Outptr_ PSID *ppsidRestrictedAppContainerSid);
